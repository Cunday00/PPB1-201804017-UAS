...
class DBAdapter(private val listDataku: ArrayList<DataModelUser>): RecyclerView.Adapter<DBAdapter.CardViewHolder>() {
    inner class CardViewHolder(itemV: View): RecyclerView.ViewHolder(itemV) {
        var tvemailku: TextView = itemV.findViewById(R.id.emailku)
        var tvpassku: TextView = itemV.findViewById(R.id.passku)
        var tvnamaku: TextView = itemV.findViewById(R.id.namaku)
        var btndelete: Button = itemV.findViewById(R.id.deletecard)
        var btnupdate: Button = itemV.findViewById(R.id.updatecard)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.datauser, parent, false)
